...
function initSqlArea() {
    ...
    area.addEventListener("keyup", keyUpEvt => {
        if (keyUpEvt.key == "Enter" && keyUpEvt.ctrlKey) {
            sendSql();
            keyUpEvt.preventDefault();
            return;
        }

        let divs = Array.from(document.querySelectorAll("div.sqlstatement"));
        console.log("keyUpEvt", keyUpEvt);

        if (keyUpEvt.key == "ArrowUp") {
            console.log("arrowUp", historyPointer, divs.length);
            
            if (historyPointer >= divs.length) {
                beep();
            }
            else {
                console.log("arrowup history found");
        ...
        if (keyUpEvt.key == "ArrowDown") {
            console.log("arrowDown", historyPointer, divs.length);
